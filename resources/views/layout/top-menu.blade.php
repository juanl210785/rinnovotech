                ...
                <div class="search-result">
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            ...
                            <a href="" class="flex items-center mt-2">
                                <div class="w-8 h-8 bg-primary/10 text-primary/80 flex items-center justify-center rounded-full">
                ...
                <div class="dropdown-menu w-56">
                    <ul class="dropdown-content bg-primary/70 before:block before:absolute before:bg-black before:inset-0 before:rounded-md before:z-[-1] text-white">
                        <li class="p-2">
                            ...
                            <div class="text-xs text-white/60 mt-0.5">{{ $fakers[0]['jobs'][0] }}</div>
                        </li>
