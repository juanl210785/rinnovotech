                        ...
                        <div class="w-full mt-3 xl:mt-0 border-2 border-dashed rounded-md p-4">
                            ...
                            <figure class="relative" style="height: 20rem;">
                                ...
                                <img class="object-contain object-center w-full h-full"
                                    src="{{ $image && in_array($image->getClientOriginalExtension(), ['jpg', 'jpeg', 'png']) ? $image->temporaryUrl() : Storage::url($product->image_path) }}"
                                    alt="">
                ...
                <div class="mt-5">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <x-text-input wire:model='productEdit.sku' value="{{ old('sku') }}" class="form-control"
                                placeholder="{{ __('Enter SKU') }}" />
                            <x-input-error :messages="$errors->get('productEdit.sku')" class="mt-2" />
                        </div>
                    </div>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <x-text-input wire:model='productEdit.name' placeholder="{{ __('Product Name') }}" />
                            <x-input-error :messages="$errors->get('productEdit.name')" class="mt-2" />
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            ...
                            <x-input-error :messages="$errors->get('productEdit.subcategory_id')" class="mt-2" />
                        </div>
                    </div>
            ...
            <div class="border border-slate-200/60 rounded-md p-5">
                ...
                <div class="mt-5">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <div class="flex flex-col sm:flex-row">
                                <div class="form-check mr-4">
                                    <input id="condition-new" value="Nuevo" wire:model='productEdit.condition'
                                ...
                                <div class="form-check mr-4 mt-2 sm:mt-0">
                                    <input id="condition-second" value="Usado" wire:model='productEdit.condition'
                                        class="form-check-input" type="radio" name="horizontal_radio_button"
                            ...
                            <x-input-error :messages="$errors->get('productEdit.condition')" class="mt-2" />
                        </div>
                    </div>
                    {{-- Status --}}
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <div class="form-check form-switch">
                                <input id="product-status-active" wire:model='productEdit.status' checked
                                    class="form-check-input" type="checkbox">
                                <label class="form-check-label"
                                    for="product-status-active">{{ __('Active') }}</label>
                            </div>
                            <x-input-error :messages="$errors->get('productEdit.status')" class="mt-2" />
                        </div>
                    </div>
                            ...
                            <div class=" w-full">
                                <div>
                                    <div class="input-group">
                                        ...
                                        <input type="text" wire:model='productEdit.price' class="form-control"
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <x-textarea name="description" wire:model='productEdit.description'></x-textarea>
                            <x-input-error :messages="$errors->get('productEdit.description')" class="mt-2" />
