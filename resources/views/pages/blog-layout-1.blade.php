        ...
        @foreach (array_slice($fakers, 0, 9) as $faker)
            <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                ...
                <div class="p-5">
                    ...
                    <div class="text-slate-600 mt-2">{{ $faker['news'][0]['short_content'] }}</div>
                </div>
                <div class="flex items-center px-5 py-3 border-t border-slate-200/60">
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full border border-slate-300 text-slate-500 mr-2 tooltip" title="Bookmark">
                    ...
                    <a href="" class="intro-x w-8 h-8 flex items-center justify-center rounded-full text-primary bg-primary/10 ml-auto tooltip" title="Share">
