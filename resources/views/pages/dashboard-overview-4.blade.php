        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                    ...
                    <div class="report-box-2 intro-y mt-5">
                        <div class="box grid grid-cols-12">
                            <div class="col-span-12 lg:col-span-4 px-8 py-12 flex flex-col justify-center">
                                ...
                                <div class="justify-start flex items-center text-slate-600 mt-12">
                                    My Total Assets
                            ...
                            <div class="col-span-12 lg:col-span-8 p-8 border-t lg:border-t-0 lg:border-l border-slate-200 border-dashed">
                                <ul
                                    class="
                                        nav
                                        nav-pills
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        <div class="flex text-slate-500 border-b border-slate-200 border-dashed pb-3 mb-3">
                            <div>Parameters</div>
                        ...
                        <button class="btn btn-outline-secondary w-full border-slate-300 border-dashed relative justify-start mb-2">
