                ...
                <div class="mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box bg-primary text-white flex items-center mb-6" role="alert">
                        <span>
                            ...
                            <button class="rounded-md bg-white bg-opacity-20 hover:bg-opacity-30 py-0.5 px-2 -my-3 ml-2">Live Preview</button>
                        </span>
                ...
                <div class="mt-14 mb-3 grid grid-cols-12 sm:gap-10 intro-y">
                    <div class="col-span-12 sm:col-span-6 md:col-span-4 py-6 sm:pl-5 md:pl-0 lg:pl-5 relative text-center sm:text-left">
                        ...
                        <div class="text-sm 2xl:text-base font-medium -mb-1">
                            Hi Angelina, <span class="text-slate-600 font-normal">welcome back!</span>
                        </div>
                        <div class="text-base 2xl:text-lg justify-center sm:justify-start flex items-center text-slate-600 leading-3 mt-14 2xl:mt-24">
                            My Total Assets
                        ...
                        <div class="2xl:text-base text-slate-600 mt-6 -mb-1">
                            Total net margin <a href="" class="underline decoration-dotted underline-offset-4 text-primary">$12,921,050</a>
                        </div>
                    ...
                    <div class="row-start-2 md:row-start-auto col-span-12 md:col-span-4 py-6 border-black border-opacity-10 border-t md:border-t-0 md:border-l md:border-r border-dashed px-10 sm:px-28 md:px-5 -mx-5">
                        <div class="flex flex-wrap items-center">
                            ...
                            <select class="form-select bg-transparent border-black border-opacity-10 mx-auto sm:mx-0 py-1.5 px-3 w-auto -mt-2">
                        ...
                        <div class="mt-10 text-slate-600">You have spent about 35% of your annual budget.</div>
                        <div class="mt-6">
                            <div class="h-[290px]">
                ...
                <div class="grid grid-cols-12 gap-6 relative intro-y">
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <div class="py-1 px-2.5 rounded-full text-xs bg-slate-300/50 text-slate-600 cursor-pointer truncate">180 Campaign</div>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        ...
                        <div class="flex items-center justify-center mt-10">
                            ...
                            <div class="w-px h-16 border border-r border-dashed border-slate-300 mx-4 xl:mx-6"></div>
                            <div>
                    ...
                    <div class="col-span-12 sm:col-span-4 xl:col-span-3 px-0 lg:px-6 xl:px-0 2xl:px-6">
                        <div class="flex items-center flex-wrap lg:flex-nowrap gap-3">
                            ...
                            <div class="py-1 px-2.5 rounded-full text-xs bg-slate-300/50 text-slate-600 cursor-pointer truncate">320 Followers</div>
                        </div>
                        <div class="px-10 sm:px-0">
                            <div class="h-[110px]">
                ...
                <div class="h-full flex flex-col">
                    <div class="box p-5 mt-6 bg-primary intro-x">
                        <div class="flex flex-wrap gap-3">
                            ...
                            <a class="flex items-center justify-center w-12 h-12 rounded-full bg-white bg-opacity-20 hover:bg-opacity-30 text-white" href="">
                        ...
                        <div class="max-h-full xl:overflow-y-auto box mt-5">
                            ...
                            <div class="tab-content px-5 pb-5">
                                <div class="tab-pane active grid grid-cols-12 gap-y-6" id="weekly-report" role="tabpanel" aria-labelledby="weekly-report-tab">
                                    ...
                                    <button class="btn btn-outline-secondary col-span-12 border-slate-300 border-dashed relative justify-start mb-2">
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 xl:col-span-4 mt-6">
                    ...
                    <div class="mt-5">
                        ...
                        @endforeach
                        <a href="" class="intro-y w-full block text-center rounded-md py-4 border border-dotted border-slate-400 text-slate-500">View More</a>
                    </div>
                </div>
