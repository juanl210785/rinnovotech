    ...
    <div class="pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="post intro-y overflow-hidden box mt-5">
                <ul class="post__tabs nav nav-tabs flex-col sm:flex-row bg-slate-200" role="tablist">
                    <li class="nav-item">
                ...
                <div class="post__content tab-content">
                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                        ...
                        <div class="border border-slate-200/60 rounded-md p-5 mt-5">
                            <div class="font-medium flex items-center border-b border-slate-200/60 pb-5">
        ...
        <div class="col-span-12 lg:col-span-4">
            <div class="intro-y box p-5">
                <div>
                    ...
                    <div class="dropdown">
                        <div class="dropdown-toggle btn w-full btn-outline-secondary flex items-center justify-start" role="button" aria-expanded="false" data-tw-toggle="dropdown">
