    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="col-span-12 lg:col-span-4 2xl:col-span-3 flex lg:block flex-col-reverse">
            <div class="intro-y box mt-5 lg:mt-0">
                ...
                <div class="p-5 border-t border-slate-200/60 flex">
            ...
            <div class="intro-y box p-5 bg-primary text-white mt-5">
                <div class="flex items-center">
                    ...
                    <div class="text-xs bg-white text-slate-700 px-1 rounded-md ml-auto">New</div>
                </div>
                ...
                <div class="font-medium flex mt-5">
                    <button type="button" class="btn py-1 px-2 border-white text-white">Take Action</button>
                    <button type="button" class="btn py-1 px-2 border-transparent text-white ml-auto">Dismiss</button>
                </div>
            </div>
        </div>
        <!-- END: Profile Menu -->
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60">
                    ...
                    <div class="p-5">
                        <div class="relative flex items-center">
                            ...
                            <div class="font-medium text-slate-600">+$19</div>
                        </div>
                        <div class="relative flex items-center mt-5">
                            ...
                            <div class="font-medium text-slate-600">+$25</div>
                        </div>
                        <div class="relative flex items-center mt-5">
                            <div class="w-12 h-12 flex-none image-fit">
                            ...
                            <div class="font-medium text-slate-600">+$21</div>
                        </div>
                    </div>
                </div>
                <!-- END: Daily Sales -->
                <!-- BEGIN: Announcement -->
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-3 border-b border-slate-200/60">
                    ...
                    <div class="tiny-slider py-5" id="announcement">
                        <div class="px-5">
                            ...
                            <div class="text-slate-600 mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever. <br><br> Lorem Ipsum is simply dummy text of the printing and typesetting industry since the 1500s.</div>
                            <div class="flex items-center mt-5">
                                <div class="px-3 py-2 text-primary bg-primary/10 rounded font-medium">02 June 2021</div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    ...
                    <div class="tiny-slider py-5" id="projects">
                        <div class="px-5">
                            <div class="font-medium text-lg">Midone Admin Template</div>
                            <div class="text-slate-600 mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</div>
                            <div class="mt-5">
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    ...
                    <div class="tiny-slider py-5" id="today-schedule">
                        <div class="px-5 text-center sm:text-left">
                            ...
                            <div class="text-slate-600 mt-2">Lorem Ipsum is simply dummy text of the printing and typesetting industry</div>
                ...
                <div class="intro-y box col-span-12 2xl:col-span-6">
                    <div class="flex items-center px-5 py-5 sm:py-0 border-b border-slate-200/60">
