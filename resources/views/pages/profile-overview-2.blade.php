                        ...
                        @foreach (array_slice($fakers, 0, 5) as $faker)
                            <div class="px-5">
                                <div class="flex flex-col lg:flex-row items-center pb-5">
                                    <div class="flex flex-col sm:flex-row items-center pr-5 lg:border-r border-slate-200/60">
                                        <div class="sm:mr-5">
                                ...
                                <div class="flex flex-col sm:flex-row items-center border-t border-slate-200/60 pt-5">
                                    <div class="w-full sm:w-auto flex justify-center sm:justify-start items-center border-b sm:border-b-0 border-slate-200/60 pb-5 sm:pb-0">
                                        <div class="px-3 py-2 text-primary bg-primary/10 rounded font-medium mr-3">{{ $faker['dates'][0] }}</div>
                ...
                <div class="intro-y box col-span-12">
                    ...
                    <div id="new-authors" class="tiny-slider py-5">
                        @foreach (array_slice($fakers, 0, 5) as $faker)
                            <div class="px-5">
                                <div class="flex flex-col lg:flex-row items-center pb-5">
                                    <div class="flex-1 flex flex-col sm:flex-row items-center pr-5 lg:border-r border-slate-200/60">
                                        <div class="sm:mr-5">
                                            <div class="w-20 h-20 image-fit">
                                    ...
                                    <div class="w-full lg:w-auto mt-6 lg:mt-0 pt-4 lg:pt-0 flex-1 flex flex-col justify-center items-center lg:items-start px-5 border-t lg:border-t-0 border-slate-200/60">
                                        <div class="flex items-center">
