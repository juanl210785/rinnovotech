    ...
    <div class="grid grid-cols-12 gap-6 mt-8">
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2">
            ...
            <div class="intro-y box bg-primary p-5 mt-6">
                <button type="button" class="btn text-slate-600 w-full bg-white mt-1">
                    <i class="w-4 h-4 mr-2" data-lucide="edit-3"></i> Compose
                </button>
                <div class="border-t border-white/10 mt-6 pt-6 text-white">
                    <a href="" class="flex items-center px-3 py-2 rounded-md bg-white/10 font-medium">
                ...
                <div class="border-t border-white/10 mt-4 pt-4 text-white">
            ...
            <div class="intro-y inbox box mt-5">
                ...
                <div class="overflow-x-auto sm:overflow-x-visible">
                    @foreach ($fakers as $faker)
                        <div class="intro-y">
                            <div class="inbox__item{{ $faker['true_false'][0] ? ' inbox__item--active' : '' }} inline-block sm:block text-slate-600 bg-slate-100 border-b border-slate-200/60">
