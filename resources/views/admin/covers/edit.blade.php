<x-app-layout :breadcrumbs="[
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ __('Edit cover') }}</h2>
    </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <x-text-input name="title" value="{{ old('title', $cover->title) }}"
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <div class="relative mx-auto">
                                        ...
                                        <input type="text" name="start_at" class="datepicker form-control pl-12"
                                            value="{{ old('start_at', $cover->start_at) }}" data-single-mode="true"
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <div class="relative mx-auto">
                                        ...
                                        <input type="text" name="end_at" class="datepicker form-control pl-12"
                                            value="{{ old('end_at', $cover->end_at) }}" data-single-mode="true"
                                            data-format="DD-MM-YYYY">
                                    </div>
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <div class="flex flex-col sm:flex-row">
                                        <div class="form-check mr-4">
                                            <input {{ $cover->is_active ? 'checked' : '' }} id="condition-active"
                                                value="1" name="is_active" class="form-check-input"
                                        ...
                                        <div class="form-check mr-4 mt-2 sm:mt-0">
                                            <input {{ !$cover->is_active ? 'checked' : '' }} id="condition-inactive"
                                                value="0" name="is_active" class="form-check-input"
                                                type="radio" name="horizontal_radio_button"
