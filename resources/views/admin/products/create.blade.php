<x-app-layout :breadcrumbs="[
    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        ...
        <div class="intro-y col-span-11 alert alert-primary alert-dismissible show flex items-center mb-6" role="alert">
            ...
            <span>Starting May 10, 2021, there will be changes to the Terms & Conditions regarding the number of
                products that may be added by the Seller. <a
                            ...
                            <div class="form-label w-full xl:w-64 xl:!mr-10">
                                <div class="text-left">
                                    ...
                                    <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                        <div>The image format is .jpg .jpeg .png and a minimum size of 300 x 300 pixels
                                            (For optimal images use a minimum size of 700 x 700 pixels).</div>
                                ...
                                <div class="text-left">
                                    ...
                                    <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                        ...
                                        <div class="mt-2">It is recommended not to enter info on mobile numbers,
                                            e-mails, etc. into the product description to protect your personal data.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="border border-slate-200/60 rounded-md p-5">
                    ...
                    <div class="mt-5">
                        <div class="form-inline items-start flex-col xl:flex-row mt-2 pt-2 first:mt-0 first:pt-0">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <div class="relative pl-5 pr-5 xl:pr-10 py-10 bg-slate-50 rounded-md">
                        ...
                        <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <div class="sm:grid grid-cols-4 gap-2">
                                    ...
                                    <input type="text" class="form-control mt-2 sm:mt-0"
                                    ...
                                    <table class="table border">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="bg-slate-50 text-slate-500 whitespace-nowrap !px-2">Price
                                                </th>
                                                ...
                                                <th class="bg-slate-50 text-slate-500 whitespace-nowrap !pl-2">Variant
                                                    Code</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <div class="overflow-x-auto">
                                    <table class="table border">
                                        <thead>
                                            <tr>
                                                <th class="!pr-2 bg-slate-50"></th>
                                                <th class="bg-slate-50"></th>
                                                <th class="!px-2 bg-slate-50 text-slate-500 whitespace-nowrap">Min.
                                                </th>
                                                <th class="!px-2 bg-slate-50 text-slate-500 whitespace-nowrap">Max.
                                                </th>
                                                <th class="!px-2 bg-slate-50 text-slate-500 whitespace-nowrap">Unit
                                                    Price</th>
                    ...
                    <div class="mt-5">
                        <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                            ...
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                ...
                                <div class="alert alert-outline-warning alert-dismissible show flex items-center bg-warning/20 mt-5"
                                    ...
                                    <span class="text-slate-800">Pay close attention to the weight of the product so
                                        that there is no difference in data with the shipping courier. <a
                        ...
                        <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                            <div class="form-label xl:w-64 xl:!mr-10">
                                <div class="text-left">
                                    ...
                                    <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                        ...
                                        during shipping. <a class="text-primary font-medium" href="">Learn
                                            More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="w-full mt-3 xl:mt-0 flex-1">
                                <div class="flex flex-col sm:flex-row">
                                    <div class="form-check mr-4">
                                        <input id="shipping-insurance-required" class="form-check-input"
                                        ...
                                        <div class="form-check-label">
                                            ...
                                            <div class="leading-relaxed text-slate-500 text-xs mt-1 w-56">
                                                You <span class="font-medium text-slate-600">require</span> the buyer
                                                to activate shipping insurance
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-check mr-4 mt-2 sm:mt-0">
                                        <input id="shipping-insurance-optional" class="form-check-input"
                                            type="radio" name="horizontal_radio_button"
                                ...
                                <div class="flex flex-col sm:flex-row">
                                    <div class="form-check mr-4">
                                        ...
                                        <label class="form-check-label"
                                            for="shipping-service-standard">Standard</label>
                                    </div>
                                    <div class="form-check mr-4 mt-2 sm:mt-0">
        ...
        <div class="intro-y col-span-2 hidden 2xl:block">
            <div class="pt-10 sticky top-0">
                <ul
                    ...
                    <li class="mb-4 border-l-2 pl-5 border-transparent">
                ...
                <div class="mt-10 bg-warning/20 border border-warning rounded-md relative p-5">
                    ...
                    <div class="leading-relaxed text-xs mt-2 text-slate-600">
                        <div>The image format is .jpg .jpeg .png and a minimum size of 300 x 300 pixels (For optimal
                            images use a minimum size of 700 x 700 pixels).</div>
